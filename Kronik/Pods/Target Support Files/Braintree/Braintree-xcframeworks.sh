...
install_xcframework "${PODS_ROOT}/Braintree/Frameworks/KountDataCollector.xcframework" "KountDataCollector" "library" "ios-arm64_x86_64-simulator" "ios-arm64_armv7"
