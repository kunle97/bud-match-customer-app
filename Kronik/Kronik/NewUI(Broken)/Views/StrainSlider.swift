...
//    var ldata = sm.fetchStrainByName(name: "Jack Herer")
    var data = [
        ...
        Strain(id: 1804, name: "Jack Herer", race: "Sativa"),
        Strain(id: 1804, name: "Jack Herer", race: "Indica"),
        Strain(id: 1804, name: "Jack Herer", race: "Hybrid"),
        Strain(id: 1804, name: "Jack Herer", race: "Sativa"),
        Strain(id: 1804, name: "Jack Herer", race: "Hybrid"),
        Strain(id: 1804, name: "Jack Herer", race: "Indica"),
...
class StrainCell: UICollectionViewCell{
    fileprivate let img: UIImageView = {
        let iv = UIImageView()
        iv.image = #imageLiteral(resourceName: "home-icon-selected")
