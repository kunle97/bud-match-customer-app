...
//  Kronik
//
//  Created by Kunle Ademefun on 8/9/21.
//
...
extension CompositionalLayoutTestViewController {
    func createLayout() -> UICollectionViewLayout {
        let layout = UICollectionViewCompositionalLayout {
            ...
            let item2 = NSCollectionLayoutItem(layoutSize: NSCollectionLayoutSize(widthDimension: .fractionalWidth(1.0), heightDimension: .absolute(120)))
            let item3 = NSCollectionLayoutItem(layoutSize: NSCollectionLayoutSize(widthDimension: .fractionalWidth(1.0), heightDimension: .absolute(80)))
...
extension CompositionalLayoutTestViewController: UICollectionViewDelegate {
